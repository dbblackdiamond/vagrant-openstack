...
apt-get -qq -y --force-yes install nova-compute sysfsutils python-novaclient
...
cp /vagrant/files/nova/nova-compute.conf.compute.orig /etc/nova/nova-compute.conf
